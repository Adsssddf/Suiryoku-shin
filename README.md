...
:root {
    ...
    /* Background Image (change the url inside the brackets, default: url(https://i.imgur.com/YWxXRI2.jpg); ) */
    --background-url: url(https://i.imgur.com/YWxXRI2.jpg);
